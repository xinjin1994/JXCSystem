...
public class Import_ReturnPO extends InvoicePO implements Serializable{
	...
	public Import_ReturnPO(String time,String customerName, String good_name, String good_type,
	...
	public Import_ReturnPO copy(){
		return new Import_ReturnPO( time, customerName, good_name, good_type, ps, serialnum,
				clerk, operator, wareHouse, number, price, id, total_money);
	}
