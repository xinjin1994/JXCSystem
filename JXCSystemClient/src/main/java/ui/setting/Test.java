...
public class Test {
	static ArrayList<SortVO> allSorts = new ArrayList<SortVO>();
	...
	private static void setSort() {
		CommodityVO com1 = new CommodityVO("1", "2", "3", 12, 12, 12,12, 12);
		CommodityVO com2 = new CommodityVO("2", "2", "3", 12, 12, 12,12, 12);
		CommodityVO com3 = new CommodityVO("3", "2", "3", 12, 12, 12,12, 12);
